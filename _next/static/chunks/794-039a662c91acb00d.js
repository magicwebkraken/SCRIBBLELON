    ...
    794: function (e, r, n) {
      ...
      var b = (function e(r) {
        var n,
          b,
          y,
          E = (M.prototype = { constructor: M, toString: null, valueOf: null }),
          A = new M(1),
          S = 20,
          _ = 4,
          R = -7,
          ...
          I = "01234567899EZ8N5ukVzSQJGu2K38f1ZydTK6JrqCx57j8yTipumpfghijklmnopqrstuvwxyz",
          T = !0;
        function M(e, r) {
          var n,
            i,
          ...
          if (null == r) {
            ...
            if ((d(r, 2, I.length, "Base"), 10 == r && T))
              return j((w = new M(e)), S + w.e + 1, _);
          ...
          if ((p = p.slice(a, ++g))) {
            if (((g -= a), h && M.DEBUG && g > 15 && (e > c || e !== o(e))))
              throw Error(u + w.s * e);
            if ((f = f - a - 1) > B) w.c = w.e = null;
              ...
              if (
                ...
                for (a && w.c.push(+p.slice(0, a)), g -= l; a < g; )
                  w.c.push(+p.slice(a, (a += l)));
        ...
        function G(e, r) {
          for (var n, t, i = 1, o = new M(e[0]); i < e.length; i++)
            (!(t = new M(e[i])).s ||
              (n = m(o, t)) === r ||
              (0 === n && o.s === r)) &&
              (o = t);
          ...
          if (m) {
            e: {
              ...
              if ((u = r - s) < 0)
                ...
                w = (c = (u %= l) - l + s) < 0 ? 0 : o((g / d[s - c - 1]) % 10);
              }
              if (
                ((t =
                  t ||
        ...
        return (
              ...
              if (null != e) {
                ...
                if (
                  ...
                  if ((n = e[r]) && n.pop)
                    ...
                    if ((d(n, -g, g, r), !n))
                      throw Error(s + r + " cannot be zero: " + n);
                    P = -(B = n < 0 ? -n : n);
                  }
                if (e.hasOwnProperty((r = "CRYPTO"))) {
                  if ((n = e[r]) !== !!n)
                    throw Error(s + r + " not true or false: " + n);
                  if (n) {
                    if (
                      ...
                      throw ((L = !n), Error(s + "crypto unavailable"));
                    L = n;
                  } else L = n;
                }
                if (
                  ...
                  if ("object" != typeof (n = e[r]))
                    throw Error(s + r + " not an object: " + n);
                  C = n;
                }
          ...
          (M.isBigNumber = function (e) {
            ...
            e: if ("[object Array]" == {}.toString.call(t)) {
              if ((1 === u || -1 === u) && i >= -g && i <= g && i === o(i)) {
                ...
                if (
                  ((r = (i + 1) % l) < 1 && (r += l), String(t[0]).length == r)
                ) {
            ...
            return function (e) {
              ...
              if ((null == e ? (e = S) : d(e, 0, g), (f = i(e / l)), L))
                if (crypto.getRandomValues) {
                  for (
                    n = crypto.getRandomValues(new Uint32Array((f *= 2)));
                    h < f;

                  )
                    (c = 131072 * n[h] + (n[h + 1] >>> 11)) >= 9e15
                  ...
                  if (!crypto.randomBytes)
                    throw ((L = !1), Error(s + "crypto unavailable"));
                  for (n = crypto.randomBytes((f *= 7)); h < f; )
                    (c =
                      ...
                      (n[h + 5] << 8) +
                      n[h + 6]) >= 9e15
                      ? crypto.randomBytes(7).copy(n, h)
                      : (p.push(c % 1e14), (h += 7));
                  h = f / 7;
                }
              if (!L) for (; h < f; ) (c = r()) < 9e15 && (p[h++] = c % 1e14);
              for (
                f = p[--h],
                  e %= l,
                  f && e && ((c = a[l - e]), (p[h] = o(f / c) * c));
                0 === p[h];
                p.pop(), h--
              );
              if (h < 0) p = [(u = 0)];
          ...
          (M.sum = function () {
            for (var e = 1, r = arguments, n = new M(r[0]); e < r.length; )
              n = n.plus(r[e++]);
            return n;
          }),
          (b = (function () {
            ...
            return function (t, i, o, s, u) {
              ...
              for (
                d >= 0 &&
                  ...
                  (x = 0),
                  (t = t.replace(".", "")),
                  (g = (m = new M(i)).pow(t.length - d)),
                  (x = a),
                  (m.c = r(O(w(g.c), g.e, "0"), 10, o, e)),
                  (m.e = m.c.length)),
                  c = a =
                    (p = r(t, i, o, u ? ((f = I), e) : ((f = e), I))).length;
                0 == p[--a];
                p.pop()
              );
              ...
              if (
                ...
                t = h ? O(f.charAt(1), -v, f.charAt(0)) : f.charAt(0);
              else {
                if (((p.length = l), h))
                  for (--o; ++p[--l] > o; )
                    (p[l] = 0), l || (++c, (p = [1].concat(p)));
                for (a = p.length; !p[--a]; );
                  ...
                  if (((m = 0), (a = r(L, b, R, y)) < 0)) {
                    if (
                      ...
                      for (
                        ...
                        m--, n(d, R < v ? D : L, v, c), (v = d.length), (a = 1);
                    ...
                    if (
                      ...
                      for (; r(L, b, R, y) < 1; )
                        m++, n(b, R < y ? D : L, y, c), (y = b.length);
                  } else 0 === a && (m++, (b = [0]));
                  (O[g++] = m),
                    b[0] ? (b[y++] = B[A] || 0) : ((b = [B[A]]), (y = 1));
            ...
            return function (o, u, f, l) {
              ...
              if (t.test(a)) o.s = isNaN(a) ? null : a < 0 ? -1 : 1;
                ...
                if (
                  ...
                  l && ((c = l), (a = a.replace(r, "$1").replace(n, "0.$1"))),
                  u != a)
                )
                  return new M(a, c);
                if (M.DEBUG)
                  throw Error(
                    s + "Not a" + (l ? " base " + l : "") + " number: " + u
                  );
                o.s = null;
              }
              o.c = o.e = null;
          ...
          (E.exponentiatedBy = E.pow =
            function (e, r) {
              ...
              if ((e = new M(e)).c && !e.isInteger())
                throw Error(s + "Exponent not an integer: " + q(e));
              if (
                (null != r && (r = new M(r)),
                (c = e.e > 14),
                !p.c ||
                ...
                return (
                  (g = new M(Math.pow(+q(p), c ? e.s * (2 - v(e)) : +q(e)))),
                  r ? g.mod(r) : g
                );
              if (((a = e.s < 0), r)) {
              ...
              for (
                ...
                if (u) {
                  if (0 === (u = o(u / 2))) break;
                  h = u % 2;
                } else if ((j((e = e.times(n)), e.e + 1, 1), e.e > 14))
                  h = v(e);
                else {
                  if (0 === (u = +q(e))) break;
                  h = u % 2;
                ...
                (p = p.times(p)),
                  f
                    ? p.c && p.c.length > f && (p.c.length = f)
                    : t && (p = p.mod(r));
              }
              return t
                ? g
                : (a && (g = A.div(g)),
                  r ? g.mod(r) : f ? j(g, x, _, undefined) : g);
            }),
          ...
          (E.minus = function (e, r) {
            ...
            if (((c = p(c)), (a = p(a)), (h = h.slice()), (u = c - a))) {
              ...
              for (
                t = (o = (u = h.length) < (r = g.length)) ? u : r, u = r = 0;
                r < t;
                r++
              )
                if (h[r] != g[r]) {
            ...
            if (
              (o && ((i = h), (h = g), (g = i), (e.s = -e.s)),
              (r = (t = g.length) - (n = h.length)) > 0)
            )
              for (; r--; h[n++] = 0);
            for (r = f - 1; t > u; ) {
              if (h[--t] < g[t]) {
                ...
                !o.c || !e.s || (e.c && !e.c[0])
                  ...
                  : (9 == U
                      ? ((i = e.s),
                        ...
                        (t.s *= i))
                      : (t = n(o, e, 0, U)),
                    (e = o.minus(t.times(e))).c[0] || 1 != U || (e.s = o.s),
                    e)
              );
            }),
          (E.multipliedBy = E.times =
            function (e, r) {
              ...
              if (!y || !E || !y[0] || !E[0])
                return (
                  !b.s || !e.s || (y && !y[0] && !E) || (E && !E[0] && !y)
                    ? (e.c = e.e = e.s = null)
                    : ((e.s *= b.s),
                      y && E ? ((e.c = [0]), (e.e = 0)) : (e.c = e.e = null)),
                  e
                );
              for (
                t = p(b.e / l) + p(e.e / l),
                  e.s *= b.s,
                  (c = y.length) < (w = E.length) &&
                    ((v = y), (y = E), (E = v), (i = c), (c = w), (w = i)),
                  i = c + w,
                  v = [];
                i--;
                v.push(0)
          ...
          (E.squareRoot = E.sqrt =
            function () {
              ...
              if (
                (0 == (f = Math.sqrt(+q(s))) || f == 1 / 0
                  ? (((r = w(u)).length + l) % 2 == 0 && (r += "0"),
                    (f = Math.sqrt(+r)),
                    (l = p((l + 1) / 2) - (l < 0 || l % 2)),
                    (t = new M(
                      (r =
                ...
                for ((f = (l = t.e) + c) < 3 && (f = 0); ; )
                  if (
                    ((o = t),
                    (t = a.times(o.plus(n(s, o, c, 1)))),
                    w(o.c).slice(0, f) === (r = w(t.c)).slice(0, f))
                  ) {
                    if (
                      (t.e < l && --f,
                      "9999" != (r = r.slice(f - 3, f + 1)) &&
                        (i || "4999" != r))
                    ) {
                      (+r && (+r.slice(1) || "5" != r.charAt(0))) ||
                        (j(t, t.e + S + 2, 1), (e = !t.times(t).eq(s)));
                      break;
                    }
          ...
          (E.toFixed = function (e, r) {
            return (
              null != e && (d(e, 0, g), (e = e + this.e + 1)), k(this, e, r)
            );
          }),
          (E.toFormat = function (e, r, n) {
            ...
            if (((t = i.toFixed(e, r)), i.c)) {
              var o,
                ...
                w = p.length;
              if (
                (l && ((o = f), (f = l), (l = o), (w -= o)), f > 0 && w > 0)
              ) {
                for (o = w % f || f, a = p.substr(0, o); o < w; o += f)
                  a += c + p.substr(o, f);
          ...
          (E.toFraction = function (e) {
            ...
            if (
              null != e &&
              ((!(c = new M(e)).isInteger() && (c.c || 1 !== c.s)) || c.lt(A))
            )
              throw Error(
                s +
                  "Argument " +
            ...
            for (
              r = new M(A),
                ...
                i = h = new M(A),
                d = w(N),
                u = r.e = d.length - v.e - 1,
                r.c[0] = a[(f = u % l) < 0 ? l + f : f],
                e = !e || c.comparedTo(r) > 0 ? (u > 0 ? r : g) : c,
                f = B,
                B = 1 / 0,
                c = new M(d),
                h.c[0] = 0;
              (p = n(c, r, 0, 1)), 1 != (o = t.plus(p.times(i))).comparedTo(e);

            )
              (t = i),
                (i = o),
                (g = h.plus(p.times((o = g)))),
                (h = o),
            ...
            return (
              ...
              (m =
                n(g, i, (u *= 2), _)
                  .minus(v)
                  .abs()
                  .comparedTo(n(h, t, u, _).minus(v).abs()) < 1
                  ? [g, i]
                  : [h, t]),
              (B = f),
              m
            ...
            return (
              null === i
                ? t
                  ...
                  : (r = "NaN")
                : (null == e
                    ? (r = i <= R || i >= D ? N(w(n.c), i) : O(w(n.c), i, "0"))
                    : 10 === e && T
                    ? (r = O(w((n = j(new M(n), S + i + 1, _)).c), n.e, "0"))
                    : (d(e, 2, I.length, "Base"),
                      (r = b(O(w(n.c), i, "0"), 10, e, t, !0))),
                  t < 0 && n.c[0] && (r = "-" + r)),
              r
            );
          }),
